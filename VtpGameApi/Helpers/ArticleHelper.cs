...
namespace VtpGameApi.Helpers
{
	public static class ArticleHelper
	{
		...
		{
			var secondArticleList = GetSecondArticleList(@"http://web.kpi.kharkov.ua/otp/ru/").OrderByDescending(x => x.ArticleId);
			var thirdArticleList = GetThirdArticleList(@"http://web.kpi.kharkov.ua/otp/ru/2018/").OrderByDescending(x => x.ArticleId);
